...
int ethernet_conn_client::send_data(void *data, int count) {
...
#define BUFF_LEN 1024
    ...
    // dest mac addr
    mac_addr dest_mac = next_mac_addr.get_next_choice();
...
void ethernet_conn_client::handle_received_msg(msg_protocol_stack&& msg) {
//    cout << "ethernet handler called" << endl;
